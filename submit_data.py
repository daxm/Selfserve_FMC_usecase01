...
#  Usually Created or Provided by User but random example values are generated by default.
protocol_list = ['UDP', 'TCP']
dev_names = ['John', 'Paul', 'George', 'Ringo']
dev_host_ip = '{}.{}.{}.{}'.format(random.randint(1, 223), random.randint(0, 255), random.randint(0, 255),
...
# ############################# "Hard Coded" Variables to be used in Main Program ############################
# FMC Server Info.
username = 'apiscript'
password = 'Admin123'
